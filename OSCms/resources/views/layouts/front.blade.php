...
<head>
	...
	<!-- Magnific Popup -->
    <link rel="stylesheet" href="{{url('/public/frontend/css/magnific-popup.min.css')}}">
	<!-- Font Awesome -->
    <link rel="stylesheet" href="{{url('/public/frontend/css/font-awesome.css')}}">
	<!-- Fancybox -->
	<link rel="stylesheet" href="{{url('/public/frontend/css/jquery.fancybox.min.css')}}">
	<!-- Themify Icons -->
    <link rel="stylesheet" href="{{url('/public/frontend/css/themify-icons.css')}}">
	<!-- Nice Select CSS -->
    <link rel="stylesheet" href="{{url('/public/frontend/css/niceselect.css')}}">
	<!-- Animate CSS -->
    <link rel="stylesheet" href="{{url('/public/frontend/css/animate.css')}}">
	<!-- Flex Slider CSS -->
    <link rel="stylesheet" href="{{url('/public/frontend/css/flex-slider.min.css')}}">
	<!-- Owl Carousel -->
...
<body class="js">
	...
	<!-- Color JS -->
	<script src="{{url('/public/frontend/js/colors.js')}}"></script>
	<!-- Slicknav JS -->
	<script src="{{url('/public/frontend/js/slicknav.min.js')}}"></script>
	<!-- Owl Carousel JS -->
	<script src="{{url('/public/frontend/js/owl-carousel.js')}}"></script>
	<!-- Magnific Popup JS -->
	<script src="{{url('/public/frontend/js/magnific-popup.js')}}"></script>
	<!-- Waypoints JS -->
	<script src="{{url('/public/frontend/js/waypoints.min.js')}}"></script>
	<!-- Countdown JS -->
	<script src="{{url('/public/frontend/js/finalcountdown.min.js')}}"></script>
	<!-- Nice Select JS -->
	<script src="{{url('/public/frontend/js/nicesellect.js')}}"></script>
	<!-- Flex Slider JS -->
	<script src="{{url('/public/frontend/js/flex-slider.js')}}"></script>
	<!-- ScrollUp JS -->
	<script src="{{url('/public/frontend/js/scrollup.js')}}"></script>
	<!-- Onepage Nav JS -->
	<script src="{{url('/public/frontend/js/onepage-nav.min.js')}}"></script>
	<!-- Easing JS -->
	<script src="{{url('/public/frontend/js/easing.js')}}"></script>
	<!-- Active JS -->
