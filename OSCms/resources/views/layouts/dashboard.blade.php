...
<head>
  ...
  <link id="pagestyle" href="{{url('/public/dashboard/css/material-dashboard.css?v=3.1.0')}}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    {{-- ____________ Side Bard _________________ --}}
  <aside
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{url('/dasbhoard/Index')}}">
        <img src="{{url('public/dashboard/img/logo-ct.png')}}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold text-white">OS CART</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white" href="{{url('/dasbhoard/Index')}}">
  ...
  <main class="main-content border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <div class="pe-md-3 align-items-right">
            <h2>SAQIB</h2>
          </div>
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{url('public/dashboard/img/team-2.jpg')}}" class="avatar avatar-sm  me-3 ">
                      </div>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{url('public/dashboard/img/small-logos/logo-spotify.svg')}}"
    ...
    <div class="container-fluid py-4">  
        {{-- ____________ Main Content _________________ --}}
        @yield("dashboard")

        {{-- ____________ Footer _________________ --}}
  ...
  {{-- ____________ Widget _________________ --}}
  ...
  <script src="{{url('/public/dashboard/js/material-dashboard.min.js?v=3.1.0')}}"></script>
</body>
