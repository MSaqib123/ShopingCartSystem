...
@section('dashboard')
    ...
    <div class="row">
        <div class="col-lg-12 position-relative z-index-2">
            {{-- _____________ Heading _____________ --}}
        ...
        {{-- _____________ Sales _____________ --}}
        <div class="row mt-4">
            <div class="col-12">
            <div class="card mb-4 ">
                <div class="d-flex">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <td class="w-30">
                                ...
                                <div>
                                    <img src="{{url('public/dashboard/img/icons/flags/US.png')}}" alt="Country flag">
                                </div>
                                <div class="ms-4">
                            ...
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                <div>
                                    <img src="{{url('public/dashboard/img/icons/flags/DE.png')}}" alt="Country flag">
                                </div>
                                <div class="ms-4">
                                    <p class="text-xs font-weight-bold mb-0 ">Country:</p>
                            ...
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                <div>
                                    <img src="{{url('public/dashboard/img/icons/flags/GB.png')}}" alt="Country flag">
                                </div>
                                <div class="ms-4">
                                    <p class="text-xs font-weight-bold mb-0 ">Country:</p>
                            ...
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                <div>
                                    <img src="{{url('public/dashboard/img/icons/flags/BR.png')}}" alt="Country flag">
                                </div>
                                <div class="ms-4">
                                    <p class="text-xs font-weight-bold mb-0 ">Country:</p>
